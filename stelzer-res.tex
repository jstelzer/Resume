...
\begin{ressection}{Skills}
  ...
  \resitem{\textbf{Cloud:} AWS (insert long list of services here), some Azure and Office365, Okta, Google Suite}
  ...
  \begin{reslist}{Computer Languages:}
    ...
    \ressubitem{Familiar with \LaTeX, Clojure, Ruby, Objective-c, Swift, Rust}
